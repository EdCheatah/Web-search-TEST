...
public class SerperNJmesPathTest {
    public static void main(String[] args) throws Exception {
        ...
        // Ahora IGUAL al código JavaScript
        String query = "site:github.com Java";
        String jsonBody = "{\"q\":\"" + query + "\",\"location\":\"United States\"}";
        ...
        JsonNode top3 = jmespath.compile("organic[0:3].{Title: title, Link: link, Snippet: snippet}").search(json);
        System.out.println("\nTop 3:");
